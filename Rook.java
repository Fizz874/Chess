...
public class Rook extends Piece{
    ...
    Rook(String side, Square square){
    ...
    public void paint(Graphics g){
        ...
        ImageIcon i;
        if(color == "white"){
            i = Square.getScaledImage(new ImageIcon("PieceImages\\white-Rook.png"), place.getLen(),place.getLen());
        } else {
            i = Square.getScaledImage(new ImageIcon("PieceImages\\black-Rook.png"), place.getLen(),place.getLen());
        }
